...
* [https://github.com/reactive-streams/reactive-streams-jvm/blob/v1.0.0/README.md#specification](https://github.com/reactive-streams/reactive-streams-jvm/blob/v1.0.0/README.md#specification)
* [https://www.arquitecturajava.com/que-es-spring-webflux/](https://www.arquitecturajava.com/que-es-spring-webflux/)
...
* [https://docs.spring.io/spring/docs/current/spring-framework-reference/web-reactive.html#webflux-reactive-spring-web](https://docs.spring.io/spring/docs/current/spring-framework-reference/web-reactive.html#webflux-reactive-spring-web)
* [https://www.arquitecturajava.com/introduccion-rxjava-observables/](https://www.arquitecturajava.com/introduccion-rxjava-observables/)
